...
ALLOWED_HOSTS = ['.gatewayhackers.com', 'gh.mikejanger.net']
...
SECRET_KEY = os.environ.get("GH_SECRET_KEY", "CHANGEME")
...
TWITTER_CONSUMER_KEY = os.environ.get('GH_TWITTER_CONSUMER_KEY')
...
MEETUP_API_KEY = os.environ.get('GH_MEETUP_API_KEY')
